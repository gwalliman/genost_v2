...
function Code(e,t){0===t.length&&(t=""),this.interpreter=e,this.codeString=t,this.codeLines=this.codeString.split("\n"),this.codeLength=this.codeLines.length,this.tokenizedCode=[],this.preprocessCode()}Code.prototype.preprocessCode=function(){for(var e=this.codeLength-1;e>=0;e--)""===this.codeLines[e].trim()&&(this.codeLines.splice(e,1),this.codeLength--)},Code.prototype.getCodeLength=function(){return this.codeLength},Code.prototype.getLine=function(e){return e>=0&&e<this.codeLength?this.codeLines[e]:void 0},Code.prototype.getTokenizedLine=function(e){return e>=0&&e<this.codeLength?this.tokenizedCode[e]:void 0},Code.prototype.checkAlphaNumeric=function(e){var t,i,n;for(i=0,n=e.length;n>i;i++)if(t=e.charCodeAt(i),!(t>47&&58>t||t>64&&91>t||t>96&&123>t))return!1;return!0},Code.prototype.exciseString=function(e){e=e.substring(1,e.length);var t=e.split(TERMINALS.SYMBOLS.QUOTE);1==t.length;var i=t.shift(),n=t.join();return[TERMINALS.SYMBOLS.QUOTE+i+TERMINALS.SYMBOLS.QUOTE,n]},Code.prototype.implode=function(e,t,i,n){for(var r=Array(),o=i;n>=o;o++)r.push(e[o]);return r.join(t)},Code.prototype.tokenizeLine=function(e,t){var i=[];this.interpreter.writeln("tokenize","Line "+e+" Codeline: "+t);var n=t.trim().split(" ");this.interpreter.writeln("tokenize","Line "+e+" Pass: "+n);for(var r=0,o=n.length;o>r;r++){var s=n[r].trim();if(this.interpreter.writeln("tokenize","Line "+e+" Token "+r+": "+s),s.length>0)if(this.checkAlphaNumeric(s))this.interpreter.writeln("tokenize","Line "+e+" "+s+" is alphanumeric, pushing"),i.push(s);else{if(this.interpreter.writeln("tokenize","Line "+e+" "+s+" is not alphanumeric"),s.indexOf(TERMINALS.SYMBOLS.QUOTE>-1)&&s.substring(0,1)==TERMINALS.SYMBOLS.QUOTE){this.interpreter.writeln("tokenize","Line "+e+" "+s+" contains a Type 3 (string)");var h=this.implode(n," ",r,n.length-1),p=this.exciseString(h);if(i.push(p[0]),h=p[1])for(var L=this.tokenizeLine(e,h),d=0,c=L.length;c>d;d++)i.push(L[d]);return i}if(s.indexOf(TERMINALS.SYMBOLS.DASH)>-1&&s.substring(0,1)==TERMINALS.SYMBOLS.DASH){this.interpreter.writeln("tokenize","Line "+e+" "+s+" contains a Type 4 (negative number)");for(var u=1,l=2,a=TERMINALS.SYMBOLS.DASH;l<=s.length&&!isNaN(s.substring(u,l));)a+=s.substring(u,l),u++,l++;i.push(a);var g=s.substring(u,s.length),f=g+this.implode(n," ",r+1,n.length-1);if(f)for(var S=this.tokenizeLine(e,f),k=0,v=S.length;v>k;k++)i.push(S[k]);return i}this.interpreter.writeln("tokenize","Line "+e+"  "+s+" contains a Type 1 (symbol)");var T=TERMINALS.searchForTerminal(s,"SYMBOLS");if(T){var z=s.split(T),C=z.shift();this.interpreter.writeln("tokenize","Line "+e+" Left: "+C);var y=z.join();this.interpreter.writeln("tokenize","Line "+e+" Right: "+y),C&&i.push.apply(i,this.tokenizeLine(e,C)),i.push(T),y&&i.push.apply(i,this.tokenizeLine(e,y))}}}return i},Code.prototype.tokenizeCode=function(){for(var e=0,t=this.codeLines.length;t>e;e++){var i=this.tokenizeLine(e,this.codeLines[e]);this.tokenizedCode.push(i)}},Code.prototype.printTokens=function(e){var t=e.join("|");return t},Code.prototype.printAllTokens=function(){var e=this,t="";return this.tokenizedCode.forEach(function(i){t+=e.printTokens(i)+"\n==========\n"}),t};
var INTERPRETER={varStack:{},methodTable:{},extMethodTable:{},currentLineNum:0,messageMask:{},code:{},body:{},getCurrentLineNum:function(){return this.currentLineNum},setCurrentLineNum:function(e){return e>=0&&e<this.code.getCodeLength()-1&&(this.currentLineNum=e),this.code.getLine(this.currentLineNum)},getCurrentLine:function(){return this.code.getLine(this.currentLineNum)},getCurrentLineTokens:function(){return this.code.getTokenizedLine(this.currentLineNum)},goToPrevLine:function(){return this.currentLineNum>0&&this.currentLineNum--,this.code.getLine(this.currentLineNum)},goToNextLine:function(){return this.currentLineNum<this.code.getCodeLength()-1&&this.currentLineNum++,this.code.getLine(this.currentLineNum)},initialize:function(){this.clearCode()},loadCode:function(e){this.code=new Code(this,e),this.code.tokenizeCode()},parseCode:function(){this.body=new Body(this,null,this.code)},printAllTokens:function(){return this.code.printAllTokens()},setMessageMask:function(e,t){this.messageMask[e]=t},canShowMessage:function(e){return this.messageMask.hasOwnProperty(e)&&this.messageMask[e]===!0?!0:!1},error:function(e,t,n,i){var r=e.toUpperCase()+" ERROR Near Line "+t+": "+n+"\n"+i;throw console.log(r),new Error(r)},write:function(e,t){return this.canShowMessage(e)?(console.log(t),t):void 0},writeln:function(e,t){return this.canShowMessage(e)?(console.log(t+"\n"),t+"\n"):void 0},clearCode:function(){this.varStack={},this.methodTable={},this.extMethodTable={},this.currentLineNum=0,this.messageMask={},this.code={},this.body={}}};module.exports={interpreter:INTERPRETER};
